...
![image-20200109085043397](./asserts/image-20200109085043397.png)

### 图形

通过可视化图表方式，就可以清晰的表达信息。

![image-20200109085106997](./asserts/image-20200109085106997.png)

### 可视化图形辅助决策

1854 年英国伦敦霍乱病流行时，斯诺博士在绘有霍乱流行地区所有道路、房屋、饮用水机井等内容的城区地图上，标出了每个霍乱病死者的住家位置，得到了霍乱病死者居住位置分布图，发现了霍乱病源之所在：布劳德大街（现布劳维克大街）的公用抽水机。

![image-20200109085134431](./asserts/image-20200109085134431.png)
...
- plot(y)
  ...
  ![image-20200109113157559](./asserts/image-20200109113157559.png)
...
- plot(y, '格式')
  ...
  - 指定格式-`marker='o'`（点）
    ...
    ![image-20200109113502385](./asserts/image-20200109113502385.png)
  ...
  - 指定格式-`marker='-'`（线）
    ...
    ![image-20200109113731473](./asserts/image-20200109113731473.png)
...
- plot(x, y)
  ...
  - 对位取元素构成一个坐标，进行绘制
    ...
    ![image-20200109114737320](./asserts/image-20200109114737320.png)
...
- plot(x1, y1, '格式1', x2, y2, '格式2' …… xn, yn, 格式n)
  ...
  - 合并写合并显示
    ...
    ![image-20200109115205092](./asserts/image-20200109115205092.png)
  ...
  - 分开写再合并显示
    ...
    ![image-20200109115314619](./asserts/image-20200109115314619.png)
  ...
  - 曲线(点比较密集)
    ...
    ![image-20200109120049951](./asserts/image-20200109120049951.png)
...
+ 设置全局字体
  ...
  ![image-20200109121209876](./asserts/image-20200109121209876.png)
...
![image-20200109143503994](./asserts/image-20200109143503994.png)
...
![image-20200109144017487](./asserts/image-20200109144017487.png)
...
- 调用plt的legend函数，传递一个标签数组，按照绘图顺序指定每次plot图形的标签。
  ...
  ![image-20200109144512356](./asserts/image-20200109144512356.png)
...
- 在绘制的时候通过label参数指定图例中显示的名称，然后调用legend函数生成图例。
  ...
  ![image-20200109144707394](./asserts/image-20200109144707394.png)
...
- legend常用的参数
  ...
  ![image-20200109145602541](./asserts/image-20200109145602541.png)
...
![image-20200109150819212](./asserts/image-20200109150819212.png)
...
- 在绘制图形时，既可以使用plt来绘制，也可以使用子绘图对象来绘制。
  ...
  ![image-20200109191130782](./asserts/image-20200109191130782.png)
...
- add_subplot方法会返回子绘图对象（轴对象），通过该对象即可实现绘图（matplotlib.axes._subplots.AxesSubplot）。
  ...
  ![image-20200109190544804](./asserts/image-20200109190544804.png)
...
- 可以通过plt.subplots_adjust方法来调整子绘图的位置与子绘图之间的距离。（left, right, top, bottom, wspace, hspace）
  ...
  ![image-20200109191742716](./asserts/image-20200109191742716.png)
...
- 创建子区域时，可以使用facecolor设置绘图区域的背景色。
  ...
  ![image-20200109192340685](./asserts/image-20200109192340685.png)
...
![image-20200109192612768](./asserts/image-20200109192612768.png)
...
+ 通过plt的subplots方法创建子绘图区域，该方法返回一个元组(两个元素)
  ...
  ![image-20200109193418794](./asserts/image-20200109193418794.png)
  ...
  + 对于多维的情况可以使用ravel()压平后循环赋值
    ...
    ![image-20200109193847785](./asserts/image-20200109193847785.png)
...
+ 可以通过sharex与sharey来指定是否共享x轴与y轴（默认为False）。
  ...
  ![image-20200109194325146](./asserts/image-20200109194325146.png)
...
- plt.xticks 设置或获取x轴显示的刻度与标签。
  ...
  - 设置刻度
    ...
    ![image-20200110182350564](./asserts/image-20200110182350564.png)
  ...
  - 设置显示标签
    ...
    ![image-20200110182806451](./asserts/image-20200110182806451.png)
...
- plt.axis 可以同时设置或获取x与y轴的刻度范围，或者是取消刻度显示。
  ...
  - equal：x与y具有同样的长度。
    ...
    ![image-20200110183609044](./asserts/image-20200110183609044.png)
...
![image-20200110183848405](./asserts/image-20200110183848405.png)
...
- ax.set_xticklabels 设置x轴显示的刻度标签。默认显示的是就是刻度值。
  ...
  - 设置标签旋转角度--rotation参数
    ...
    ![image-20200110190139951](./asserts/image-20200110190139951.png)
...
- ax.set_xlabel 设置x轴的标签说明。
  ...
  ![image-20200110185700536](./asserts/image-20200110185700536.png)
...
+ plt.text 显示文本（基于坐标）
  ...
  ![image-20200110190901510](./asserts/image-20200110190901510.png)
...
+ plt.figtext 显示文本（基于图片比例）
  ...
  ![image-20200110191137306](./asserts/image-20200110191137306.png)
...
![image-20200110192540937](./asserts/image-20200110192540937.png)
...
![image-20200112084545571](./asserts/image-20200112084545571.png)
...
![image-20200109141004987](./asserts/image-20200109141004987.png)
...
+ 使用plt.bar 柱形图/plt.barh 条形图
  ...
  ![image-20200112090709590](./asserts/image-20200112090709590.png)

  ```python
  plt.barh(y=['第一季度','第二季度','第三季度','第四季度'],width=[10,20,30,40])
  ```

  ![image-20200112091003640](./asserts/image-20200112091003640.png)
...
+ 使用----plt.pie 饼图
  ...
  ![image-20200112092333609](./asserts/image-20200112092333609.png)
...
+ 使用---scatter
  + marker 点的标记。
    ...
    ![image-20200112093854152](./asserts/image-20200112093854152.png)
  ...
  + color与s参数可以统一设置，也可以为每一个点单独设置。
    ...
    ![image-20200112094432129](./asserts/image-20200112094432129.png)
...
+ 使用---plt.hist
  ...
  + 返回两个数组
    ...
    ![image-20200112120500618](./asserts/image-20200112120500618.png)
...
+ 概念
  ...
  ![image-20200112122725708](./asserts/image-20200112122725708.png)
...
![image-20200112123415016](./asserts/image-20200112123415016.png)
...
- bar：柱形图
  ...
  ![image-20200112123515071](./asserts/image-20200112123515071.png)
...
- pie：饼图
  ...
  ![image-20200112130710009](./asserts/image-20200112130710009.png)
...
- stacked：是否堆叠。
  ...
  ![image-20200112124407558](./asserts/image-20200112124407558.png)