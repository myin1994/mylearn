...
- read_csv
  ...
  - 返回DataFrame类型。
    ...
    ![image-20200103115820886](07 数据处理.assets/image-20200103115820886.png)
...
- header---标题
  ...
  ![image-20200103115955298](07 数据处理.assets/image-20200103115955298.png)
...
- index_col---指定行标签
  ...
  - 可以指定作为唯一标记的列充当行标签（行索引）
    ...
    ![image-20200103143106050](07 数据处理.assets/image-20200103143106050.png)
...
- usecols---指定选中列
  ...
  - 通过参数来显示指定需要加载哪些列。（默认为所有列）
    ...
    ![image-20200103143353806](07 数据处理.assets/image-20200103143353806.png)
...
- subset：删除空值时，其他轴方向考虑的标签子集。
  ...
  ![image-20200103162041967](07 数据处理.assets/image-20200103162041967.png)
...
- keys：可以用来区分不同的数据组。(生成层级索引，能够观测数据的来源。)
  ...
  ![image-20200105171238049](07 数据处理.assets/image-20200105171238049.png)
...
- join_axes：指定连接结果集中保留的索引。
  ...
  ![image-20200105171733652](07 数据处理.assets/image-20200105171733652.png)
...
- how：指定连接方式。可以是
  ...
  - left---左表数据一定显示(右表不能对应的显示为空-NaN)
    ...
    ![image-20200105173120092](07 数据处理.assets/image-20200105173120092.png)
...
- on 显式指定使用哪些字段进行等值连接。
  ...
  ![image-20200105173834555](07 数据处理.assets/image-20200105173834555.png)
...
- left_on / right_on：指定左右DataFrame中连接所使用的列。
  ...
  ![image-20200105174146515](07 数据处理.assets/image-20200105174146515.png)
...
- suffixes：当两个DataFrame列名相同时，指定每个列名的后缀（用来区分），默认为_x与_y。
  ...
  ![image-20200105174719140](07 数据处理.assets/image-20200105174719140.png)
...
+ merge方法在列名相同的时候，存在默认的后缀(_x,_y)，而join方法没有默认的后缀，需要我们显式指定。
  ...
  ![image-20200105175118475](07 数据处理.assets/image-20200105175118475.png)
